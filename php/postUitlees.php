...
while ($rij = mysqli_fetch_array($resultaat)){
    ...
    <div class="card post">
        ...
        <div class="card-footer text-muted">
            <?= $rij['postDate'] ?> Likes: <?= $row['aantalLikes'] ?> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16">
